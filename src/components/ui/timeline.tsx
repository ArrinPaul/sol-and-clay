  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="font-headline text-4xl mb-4 text-dark-brown max-w-4xl">
          Our Journey
        </h2>
        <p className="text-muted-foreground text-base max-w-2xl">
          From a simple idea to a curated collection of soulful objects, this is the story of how Sol & Clay came to be.
        </p>
      </div>
