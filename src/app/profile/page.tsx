...
import { LogOut, ShoppingBag, Package, User as UserIcon, Mail, Calendar, MapPin, Phone, CreditCard, Truck, Heart, Settings } from 'lucide-react';
                ...
                <CardContent className="pt-6">
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                      Start exploring our handcrafted collections and find the perfect piece for your home.
                    </p>
